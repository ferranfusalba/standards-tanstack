...
const bcp47VariantsByLanguage: Record<string, string[]> = {
  ...
  en: ['en-CA-newfound', 'en-basiceng', 'en-boont', 'en-cornu', 'en-emodeng', 'en-oxendict', 'en-scotland', 'en-scouse', 'en-spanglis', 'en-unifon'],
  ...
  lv: ['lv-vecdruka'],
  nn: ['nn-hognorsk'],
  oc: ['oc-aranes', 'oc-aranes-grclass', 'oc-aranes-grmistr', 'oc-auvern', 'oc-auvern-grclass', 'oc-auvern-grmistr', 'oc-cisaup', 'oc-cisaup-grclass', 'oc-cisaup-grital', 'oc-cisaup-grmistr', 'oc-creiss', 'oc-creiss-grclass', 'oc-creiss-grmistr', 'oc-gascon', 'oc-gascon-grclass', 'oc-gascon-grmistr', 'oc-grclass', 'oc-grital', 'oc-grmistr', 'oc-lemosin', 'oc-lemosin-grclass', 'oc-lemosin-grmistr', 'oc-lengadoc', 'oc-lengadoc-grclass', 'oc-lengadoc-grmistr', 'oc-nicard', 'oc-nicard-grclass', 'oc-nicard-grital', 'oc-nicard-grmistr', 'oc-provenc', 'oc-provenc-grclass', 'oc-provenc-grital', 'oc-provenc-grmistr', 'oc-vivaraup', 'oc-vivaraup-grclass', 'oc-vivaraup-grmistr'],
  pl: ['pl-kociewie'],
  pt: ['pt-BR-abl1943', 'pt-ao1990', 'pt-colb1945'],
  rm: ['rm-jauer', 'rm-puter', 'rm-rumgr', 'rm-surmiran', 'rm-sursilv', 'rm-sutsilv', 'rm-vallader'],
  ru: ['ru-luna1918', 'ru-petr1708'],
  sa: ['sa-bauddha', 'sa-itihasa', 'sa-laukika', 'sa-vaidika'],
  sl: ['sl-bohoric', 'sl-dajnko', 'sl-metelko', 'sl-nedis', 'sl-rozaj', 'sl-rozaj-1994', 'sl-rozaj-biske', 'sl-rozaj-biske-1994', 'sl-rozaj-lipaw', 'sl-rozaj-njiva', 'sl-rozaj-njiva-1994', 'sl-rozaj-osojs', 'sl-rozaj-osojs-1994', 'sl-rozaj-solba', 'sl-rozaj-solba-1994'],
  sr: ['sr-Cyrl-ekavsk', 'sr-Cyrl-ijekavsk', 'sr-Latn-ekavsk', 'sr-Latn-ijekavsk', 'sr-ekavsk', 'sr-ijekavsk'],
  tk: ['tk-baku1926'],
  tt: ['tt-baku1926'],
...
const cldrVariantsByLanguage: Record<string, string[]> = {
  ...
  eu: [],
  fa: ['fa-AF'],
  ff: ['ff-Adlm', 'ff-Adlm-BF', 'ff-Adlm-CM', 'ff-Adlm-GH', 'ff-Adlm-GM', 'ff-Adlm-GW', 'ff-Adlm-LR', 'ff-Adlm-MR', 'ff-Adlm-NE', 'ff-Adlm-NG', 'ff-Adlm-SL', 'ff-Adlm-SN', 'ff-Latn', 'ff-Latn-BF', 'ff-Latn-CM', 'ff-Latn-GH', 'ff-Latn-GM', 'ff-Latn-GN', 'ff-Latn-GW', 'ff-Latn-LR', 'ff-Latn-MR', 'ff-Latn-NE', 'ff-Latn-NG', 'ff-Latn-SL'],
  fi: [],
  fj: [],
  fo: ['fo-DK'],
  ...
  sq: ['sq-MK', 'sq-XK'],
  sr: ['sr-Cyrl', 'sr-Cyrl-BA', 'sr-Cyrl-ME', 'sr-Cyrl-XK', 'sr-Latn', 'sr-Latn-BA', 'sr-Latn-ME', 'sr-Latn-XK'],
  ss: ['ss-SZ'],
  st: ['st-LS'],
  su: ['su-Latn'],
  sv: ['sv-AX', 'sv-FI'],
  ...
  yo: ['yo-BJ'],
  za: [],
  zh: ['zh-Hans', 'zh-Hans-HK', 'zh-Hans-MO', 'zh-Hans-MY', 'zh-Hans-SG', 'zh-Hant', 'zh-Hant-HK', 'zh-Hant-MO', 'zh-Hant-MY', 'zh-Latn'],
  zu: [],
}
